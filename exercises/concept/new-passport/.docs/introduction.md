...
The [special form with](https://hexdocs.pm/elixir/Kernel.SpecialForms.html#with/1) provides a way to focus on the "happy path" of a series of potentially failing steps and deal with the failures later.
